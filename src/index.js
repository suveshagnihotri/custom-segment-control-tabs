...
const getAccessibilityLabelByIndex = (accessibilityLabels, index) => {
	return accessibilityLabels && accessibilityLabels.length > 0 && accessibilityLabels[index]
...
const SegmentedControlTab = ({
	...
	return (
		<View style={[styles.tabsContainerStyle, tabsContainerStyle]} removeClippedSubviews={false}>
